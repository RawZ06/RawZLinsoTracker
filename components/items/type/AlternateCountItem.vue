...
<template>
  ...
  >
    ...
    ></IconItem>
    <div :style="{fontFamily: 'countItemFont', color: stateStore.trackerState[id]  === max ? 'var(--color-incrementalItemFont-max)' : 'var(--color-incrementalItemFont)', hidden: stateStore.trackerState[id] === 0 ? 'var(--color-incrementalItemFont-max)' : 'var(--color-incrementalItemFont)'}" class="z-20 absolute bottom-[-3px] right-[-10px] align-middle inline-block text-center w-full text-lg select-none text-shadow">
